...
C
 ...
 20   FORMAT (T12,'----DSS---Debug:  Enter ZPTREC;  Unit:',I5,/,
...
C
 ...
 50   FORMAT (T3,'-----DSS---ZPTREC;  Unit',I5,':  File has been',
...
C
 ...
 180  FORMAT (T5,'----ZPTREC, Record:',I7,'  JBUFF:',I3,'  LATEND:',L2)
C
...
C     "Zero out" the remainder of the buffer
 ...
 190  FORMAT (T5,'---ZPTREC;  Zeroing Rec:',I7,', From:',I4,', To:',I4)
      DO 200 I=J,NBSIZE
      IBUFF(I,JBUFF) = 0
 200  CONTINUE
      ENDIF
...
C     Write any Debug exit messages
      ...
      WRITE (MUNIT,22) JBUNIT
      WRITE (MUNIT,24) JWRITE
 810  FORMAT (T12,'-----DSS---Debug:  Exit ZPTREC',/,
