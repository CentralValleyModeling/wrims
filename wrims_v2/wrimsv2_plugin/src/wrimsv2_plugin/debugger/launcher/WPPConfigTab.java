...
public class WPPConfigTab extends AbstractLaunchConfigurationTab {
	...
	public void createControl(Composite parent) {
		...
		DSSHDF5ConversionButton.addSelectionListener(new SelectionListener(){
			...
			public void widgetSelected(SelectionEvent e) {
				...
				try {
					...
					out.println();
					out.println("jre\\bin\\java -Xmx4096m -Xss1024K -XX:+CreateMinidumpOnCrash -Duser.timezone=Etc/GMT+8 -Djava.library.path=\"lib\" -cp \"lib\\external;lib\\WRIMSv2.jar;lib\\jep-3.8.2.jar;lib\\jna-3.5.1.jar;lib\\commons-io-2.1.jar;lib\\XAOptimizer.jar;lib\\lpsolve55j.jar;lib\\coinor.jar;lib\\gurobi.jar;lib\\hec-monolith-3.3.22.jar;lib\\hec-nucleus-metadata-2.0.1.jar;lib\\flogger-0.5.1.jar;lib\\flogger-system-backend-0.5.1.jar;lib\\jnios.jar;lib\\jpy.jar;lib\\misc.jar;lib\\pd.jar;lib\\vista.jar;lib\\guava-11.0.2.jar;lib\\javatuples-1.2.jar;lib\\kryo-2.24.0.jar;lib\\minlog-1.2.jar;lib\\objenesis-1.2.jar;lib\\jarh5obj.jar;lib\\jarhdf-2.10.0.jar;lib\\jarhdf5-2.10.0.jar;lib\\jarhdfobj.jar;lib\\slf4j-api-1.7.5.jar;lib\\slf4j-nop-1.7.5.jar;lib\\mysql-connector-java-5.1.42-bin.jar;lib\\sqljdbc4-2.0.jar;lib\\java-object-diff-0.95.jar\" wrimsv2.hdf5.DSSHDF5Converter -launch="+launchFileName);
					out.close();
		...
		gd.horizontalSpan =2;
		bvHecLib6.setText("6");
		bvHecLib6.setLayoutData(gd);
		bvHecLib6.setFont(font);
		bvHecLib6.setEnabled(true);
		bvHecLib6.addSelectionListener(new SelectionListener(){
		...
		gd.horizontalSpan =2;
		bvHecLib7.setText("7");
		bvHecLib7.setLayoutData(gd);
		bvHecLib7.setFont(font);
		bvHecLib7.setEnabled(true);
		bvHecLib7.addSelectionListener(new SelectionListener(){
	...
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		...
		if (isBVHecLib6Sel){
			...
			configuration.setAttribute(DebugCorePlugin.ATTR_WPP_VHECLIB, "7");
		}
	}
