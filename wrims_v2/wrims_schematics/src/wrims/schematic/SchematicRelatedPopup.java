 ...
 */
public class SchematicRelatedPopup implements ActionListener, ItemListener {
	JTextArea output;
	...
	public JMenuBar createMenuBar() {
		...
		// submenu.setEnabled(false); //CB TO DO - figure out best how to access
		// lookup tables, then enable this
	...
	protected static ImageIcon createImageIcon(String path) {
		java.net.URL imgURL = SchematicRelatedPopup.class.getResource(path);
		if (imgURL != null) {
	...
	private static void createAndShowGUI() {
		...
		SchematicRelatedPopup demo = new SchematicRelatedPopup();
