...
public class PluginCore {
	...
	public static HashMap<String, String>[] allSchematicVariableUnitsCFS=new HashMap[3];
	public static HashMap<String, String>[] allSchematicVariableUnitsTAF=new HashMap[3];
}
