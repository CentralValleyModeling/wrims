from vutils import *
from vista.set import PathPartPredicate
...
g.filterBy(PathPartPredicate('cos', Pathname.B_PART), selecting)
...
tw = timewindow('01JAN1982 0100 - 01JAN1982 0500')
...
DSSUtil.createDataReference('myServer','myFile.dss','/MY/PATH/NAME////',ds)
