...
public class FunctionAnnLineGen extends ExternalFunction{
	...
	public void execute(Stack stack) {
		...
		float result = AnnLineGen(Qsac_prv0, Qsac_prv1, Qsac_prv2, Qsac_prv3, Qexp_prv0, Qexp_prv1,
			Qexp_prv2, Qexp_prv3, Qsjr_prv0, Qsjr_prv1, Qsjr_prv2, Qsjr_prv3, Qsjr_fut, DXC_prv0,
			DXC_prv1, DXC_prv2, DXC_prv3, DXC_fut, DICU_prv0, DICU_prv1, DICU_prv2, DICU_prv3,
			DICU_fut, Qsac_oth_prv0, Qsac_oth_prv1, Qsac_oth_prv2, Qsac_oth_prv3, Qsac_oth_fut,
			...
			mon0, mon1, mon2, mon3, mon4, ECTARGET, linear1, linear2, location, variable, ave_type, currMonth,
			currYear, ForceOption);

		if (DEBUG) {
			System.out.println("*************AnnLineGen call**************");
			System.out.println("Qsac_prv0 = " + Qsac_prv0);
			System.out.println("Qsac_prv1 = " + Qsac_prv1);
			System.out.println("Qsac_prv2 = " + Qsac_prv2);
			System.out.println("Qsac_prv3 = " + Qsac_prv3);
			System.out.println("Qexp_prv0 = " + Qexp_prv0);
			System.out.println("Qexp_prv1 = " + Qexp_prv1);
			System.out.println("Qexp_prv2 = " + Qexp_prv2);
			System.out.println("Qexp_prv3 = " + Qexp_prv3);
			System.out.println("Qsjr_prv0 = " + Qsjr_prv0);
			System.out.println("Qsjr_prv1 = " + Qsjr_prv1);
			System.out.println("Qsjr_prv2 = " + Qsjr_prv2);
			System.out.println("Qsjr_prv3 = " + Qsjr_prv3);
			System.out.println("Qsjr_fut = " + Qsjr_fut);
			System.out.println("DXC_prv0 = " + DXC_prv0);
			System.out.println("DXC_prv1 = " + DXC_prv1);
			System.out.println("DXC_prv2 = " + DXC_prv2);
			System.out.println("DXC_prv3 = " + DXC_prv3);
			System.out.println("DXC_fut = " + DXC_fut);
			System.out.println("DICU_prv0 = " + DICU_prv0);
			System.out.println("DICU_prv1 = " + DICU_prv1);
			System.out.println("DICU_prv2 = " + DICU_prv2);
			System.out.println("DICU_prv3 = " + DICU_prv3);
			System.out.println("DICU_fut = " + DICU_fut);
			System.out.println("Qsac_oth_prv0 = " + Qsac_oth_prv0);
			System.out.println("Qsac_oth_prv1 = " + Qsac_oth_prv1);
			System.out.println("Qsac_oth_prv2 = " + Qsac_oth_prv2);
			System.out.println("Qsac_oth_prv3 = " + Qsac_oth_prv3);
			System.out.println("Qsac_oth_fut = " + Qsac_oth_fut);
			System.out.println("Qexp_oth_prv0 = " + Qexp_oth_prv0);
			System.out.println("Qexp_oth_prv1 = " + Qexp_oth_prv1);
			System.out.println("Qexp_oth_prv2 = " + Qexp_oth_prv2);
			System.out.println("Qexp_oth_prv3 = " + Qexp_oth_prv3);
			System.out.println("Qexp_oth_fut = " + Qexp_oth_fut);
			System.out.println("VernEC_prv0 = " + VernEC_prv0);
			System.out.println("VernEC_prv1 = " + VernEC_prv1);
			System.out.println("VernEC_prv2 = " + VernEC_prv2);
			System.out.println("VernEC_prv3 = " + VernEC_prv3);
			System.out.println("VernEC_fut = " + VernEC_fut);
			...
			System.out.println("ECTARGET = " + ECTARGET);
			System.out.println("linear1 = " + linear1);
			System.out.println("linear2 = " + linear2);
			...
			System.out.println("ForceOption = " + ForceOption);
	...
	public native float AnnLineGen(float Qsac_prv0, float Qsac_prv1, float Qsac_prv2,
		...
		float ECTARGET, float linear1, float linear2, int location, int variable, int ave_type,
		int currMonth, int currYear, int ForceOption);
}
