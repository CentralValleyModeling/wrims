...
//	private Vector<DerivedTimeSeries> _dtsList = null; 	
	...
	public DTSWrapper(String dtsName, DerivedTimeSeries dts, Hashtable<String, String> varNameToPathMap) {
		this(dtsName, dts);
		setVariableNameToDssPathMap(varNameToPathMap);
	}
		
//	public DTSWrapper(String dtsName, DerivedTimeSeries dts, Hashtable<String, String> varNameToPathMap, Vector<DerivedTimeSeries> dstList) { 
	public DTSWrapper(String dtsName, DerivedTimeSeries dts, Hashtable<String, String> varNameToPathMap, Vector<DTSWrapper> dstList) {	
	...
	public void setVariableNameToDssPathMap(Hashtable<String, String> varNameToPathMap) {
