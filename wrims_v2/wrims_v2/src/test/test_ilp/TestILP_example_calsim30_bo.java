...
public class TestILP_example_calsim30_bo {
	...
	public void calsim3_step1() throws RecognitionException, IOException{
		...
		"10",
		 ...
		 "31", 
		 "ILP", 
		 "csv_TestIlp_example_calsim30_bo"};

		FilePaths.ilpFileDirectory = "ilp_TestIlp_example_calsim30_bo";
		//FilePaths.ilpFile = "test.ilp";
		
        new Controller(controlDataString);

        
        expected = 1.748286645871391E10;
