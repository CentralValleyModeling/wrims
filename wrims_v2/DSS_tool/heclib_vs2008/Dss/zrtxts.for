...
C     Check that IFLTAB is valid (e.g., the DSS file is open)
      IF (IFLTAB(1).NE.6) CALL ZERROR (IFLTAB, 5, 'ZRTXTS',
     * 0, IFLTAB, ' ', 0, ' ',0)
C
C
C
...
C
 ...
 820  FORMAT(T5,'----- Exit ZRTXTS, Number of bytes read:',I6,
     * ',  Status:',I5)
C
      RETURN
C
C
 ...
 901  FORMAT (/,' *****DSS*** ZRTXTS:  ERROR - Record Not Identified',
