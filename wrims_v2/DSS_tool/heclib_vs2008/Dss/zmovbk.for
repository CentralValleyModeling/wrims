      SUBROUTINE ZMOVBK (SVALUES, DVALUES, LDOUBLE, LFILDOB,
...
C
 ...
 25   FORMAT (T10,' --- ZMOVBK CALCULATIONS --',
...
C              Copy single array to single
               DO 100 I=NSTART,ILIM
                  ...
                  IF (IFLAG.LT.0) THEN
                     IF (IFLAG.EQ.-1) THEN
                        IF ((BLOCK(M).GT.-900.0).OR.
     *                  (BLOCK(M).LT.-910.0)) GO TO 100
                     ELSE IF (IFLAG.EQ.-4) THEN
                        IF ((SVALUES(I).LT.-900.0).AND.
     *              (SVALUES(I).GT.-910.0)) GO TO 100
                     ENDIF
                  ENDIF
                  IF (LTOL) THEN
...
C              Copy double array to double
               DO 120 I=NSTART,ILIM
                  ...
                  IF (IFLAG.LT.0) THEN
                     IF (IFLAG.EQ.-1) THEN
                        IF ((DBLOCK(M).GT.-900.0).OR.
     *                  (DBLOCK(M).LT.-910.0)) GO TO 120
                     ELSE IF (IFLAG.EQ.-4) THEN
                        IF ((DVALUES(I).LT.-900.0).AND.
     *                  (DVALUES(I).GT.-910.0)) GO TO 120
                     ENDIF
                  ENDIF
                  IF (LTOL) THEN
...
C              Copy single array to double
               DO 140 I=NSTART,ILIM
                  ...
                  IF (IFLAG.LT.0) THEN
                     IF (IFLAG.EQ.-1) THEN
                        IF ((DBLOCK(M).GT.-900.0).OR.
     *                  (DBLOCK(M).LT.-903.0)) GO TO 140
                     ELSE IF (IFLAG.EQ.-4) THEN
                        IF ((SVALUES(I).LT.-900.0).AND.
     *                  (SVALUES(I).GT.-903.0)) GO TO 140
                     ENDIF
                  ENDIF
                  IF (LTOL) THEN
...
C              This is not leagl, and is taken care of in ZSRTSI
               GO TO 920
            ENDIF
C
         ENDIF
...
C           Copy single array to single
            ...
            DO 160 I=NSTART,ILIM
               ...
               IF (IFLAG.LT.0) THEN
                  IF (IFLAG.EQ.-1) THEN
                     IF ((BLOCK(M).GT.-900.0).OR.
     *               (BLOCK(M).LT.-910.0)) GO TO 160
                  ELSE IF (IFLAG.EQ.-4) THEN
                     IF ((SVALUES(I).LT.-900.0).AND.
     *               (SVALUES(I).GT.-910.0)) GO TO 160
                  ENDIF
               ENDIF
C              Check for quality protection bit
               IF (LQPBIT.AND.LQVALS) THEN
C                 If protection bit on, and
                  IF (ZTSTQP(IBLOCK(M+1)).AND.(.NOT.ZTSTQP(JQUAL(I))))
     *                GO TO 160
               ENDIF
C              Copy data value
               IF (LTOL) THEN
...
C           Copy double array to double
            ...
            DO 180 I=NSTART,ILIM
               ...
               IF (IFLAG.LT.0) THEN
                  IF (IFLAG.EQ.-1) THEN
                     IF ((DBLOCK(M).GT.-900.0).OR.
     *               (DBLOCK(M).LT.-910.0)) GO TO 180
                  ELSE IF (IFLAG.EQ.-4) THEN
                     IF ((DVALUES(I).LT.-900.0).AND.
     *               (DVALUES(I).GT.-910.0)) GO TO 180
                  ENDIF
               ENDIF
C              Check for quality protection bit
               IF (LQPBIT.AND.LQVALS) THEN
C                 If protection bit on, and
                  IF (ZTSTQP(IBLOCK((NDATA*2)+M)).AND.
     *               (.NOT.ZTSTQP(JQUAL(I)))) GO TO 180
               ENDIF
C              Copy data value
               IF (LTOL) THEN
...
C     Probably cannot get here
      WRITE (MUNIT, 921)
 921  FORMAT (/, ' ***** ERROR - ZMOVBK - Illegal operation')
      ISTAT = 22
      RETURN
C
      END
