...
D:/cvwrsm/trunk/3rd_party/MinGW/bin/gcc -Wall -D_JNI_IMPLEMENTATION_ -Wl,--kill-at -shared -o InterfaceToAnn.dll wrimsv2_external_FunctionAnnEC.o -L./ Ann7inp_CA.dll
