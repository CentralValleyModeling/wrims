# Initialize plotting for flow data
# set the time window
...
file_mdl = '/delta5/calibration/realtide/hydro/output-files/hydro.dss'; url_mdl = 'local'
#file_mdl = 'd:/dsm2/io/realtide/output-files/hydro-my.dss'; url_mdl = 'local'

file_obs = '/export/home/www/htdocs/dss/db/hydro.dss'; url_obs = 'iep.water.ca.gov'
...
# 
file_paths='flow_stas.dat'
#file_paths='d:/dsm2/local_scripts/flow_stas.dat'
