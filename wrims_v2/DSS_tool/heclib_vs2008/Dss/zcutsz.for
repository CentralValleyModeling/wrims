      SUBROUTINE ZCUTSZ(IFLTAB, CPATH, ISIZE, ISTATUS)
C
C     Get the size of buffer needed to do a cut/copy operation (zcut)
C
...
C
 ...
 20      FORMAT (T6,'-----DSS---Debug: Enter ZCUTSZ',/,
     *   T5,'Unit:',I5,'  Path: ',A)
      ENDIF
C
C
...
C
 ...
 820  FORMAT (T6,'-----DSS---Debug: Exit ZCUTSZ, Size:',I5,
     * ', Status:',I4)
      RETURN
C
      END
