...
/*CB Eclipse created a Run Configuration behind my back so I commented main out!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	public static void main (String args[])  {

        String fn = "D:/workspace/hecdss/wrims/dss/data/test.dsv";
        //String fn = "data/test.dsv";
...
//        System.out.println("HASH: "+vf.var2value);
        ...
        ViewerFile vf2 = new ViewerFile(outfn);
        vf2.write(vf.var2value);
    } */
}
