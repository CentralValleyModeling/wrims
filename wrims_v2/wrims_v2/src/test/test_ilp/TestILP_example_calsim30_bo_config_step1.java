...
public class TestILP_example_calsim30_bo_config_step1 {
	...
	public void calsim3_step1() throws RecognitionException, IOException{
		...
		"-config=\"D:\\cvwrsm\\trunk\\wrims_v2\\wrims_v2\\examples\\calsim30_bo_svn51\\conv\\Run\\step1.config\"" 

		};

		FilePaths.ilpFileDirectory = studyPath + "ilp_TestIlp_example_calsim30_bo_config_step1";
		//FilePaths.ilpFile = "test.ilp";		
		Error.clear();
        new ControllerBatch(controlDataString);
        
        expected = 1.748286082066914E10; 
