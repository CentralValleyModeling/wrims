...
public class WPPLaunchDelegate extends LaunchConfigurationDelegate {
	...
	public void generateBatch(PrintWriter out, String mode, int requestPort, int eventPort, String configFilePath){
		...
		*/
		String cbcFolder="lib\\solvers\\cbc_"+DebugCorePlugin.cbcSelVer;
		String gurobiFolder="lib\\solvers\\gurobi_"+DebugCorePlugin.gurobiSelVer;
		String xaFolder="lib\\solvers\\xa_"+DebugCorePlugin.xaSelVer;
		String solverJarFilePaths=FileProcess.createSolverJarFilePaths(cbcFolder, gurobiFolder, xaFolder, DebugCorePlugin.cbcSelVer, DebugCorePlugin.gurobiSelVer, DebugCorePlugin.xaSelVer);
		
		if (compileOnly.equalsIgnoreCase("no")){
			if (mode.equals("debug")){
				out.println("jre\\bin\\java -Xmx"+DebugCorePlugin.xmx+"m -Xss1024K -XX:+CreateMinidumpOnCrash -Duser.timezone=Etc/GMT+8 -Djava.library.path=\"" + externalPath+";" + cbcFolder +";"+gurobiFolder+";"+xaFolder+ ";lib\" -cp \""+externalPath+";"+"lib\\external;lib\\WRIMSv2.jar;lib\\libtensorflow-1.14.0.jar;lib\\calsurrogate.jar;lib\\jep-3.8.2.jar;lib\\jna-3.5.1.jar;lib\\commons-io-2.1.jar;lib\\"+jarXA+";lib\\lpsolve55j.jar;"+solverJarFilePaths+"lib\\heclib.jar;lib\\jnios.jar;lib\\jpy.jar;lib\\misc.jar;lib\\pd.jar;lib\\vista.jar;lib\\guava-11.0.2.jar;lib\\javatuples-1.2.jar;lib\\kryo-2.24.0.jar;lib\\minlog-1.2.jar;lib\\objenesis-1.2.jar;lib\\jarh5obj.jar;lib\\jarhdf-2.10.0.jar;lib\\jarhdf5-2.10.0.jar;lib\\jarhdfobj.jar;lib\\slf4j-api-1.7.5.jar;lib\\slf4j-nop-1.7.5.jar;lib\\mysql-connector-java-5.1.42-bin.jar;lib\\sqljdbc4-2.0.jar;lib\\java-object-diff-0.95.jar\" wrimsv2.components.DebugInterface "+requestPort+" "+eventPort+" "+"-config="+configFilePath);
			}else{
				out.println("jre\\bin\\java -Xmx"+DebugCorePlugin.xmx+"m -Xss1024K -XX:+CreateMinidumpOnCrash -Duser.timezone=Etc/GMT+8 -Dname="+requestPort+" -Djava.library.path=\"" + externalPath +";" + cbcFolder +";"+gurobiFolder+";"+xaFolder+ ";lib\" -cp \""+externalPath+";"+"lib\\external;lib\\WRIMSv2.jar;lib\\libtensorflow-1.14.0.jar;lib\\calsurrogate.jar;lib\\jep-3.8.2.jar;lib\\jna-3.5.1.jar;lib\\commons-io-2.1.jar;lib\\"+jarXA+";lib\\lpsolve55j.jar;"+solverJarFilePaths+"lib\\heclib.jar;lib\\jnios.jar;lib\\jpy.jar;lib\\misc.jar;lib\\pd.jar;lib\\vista.jar;lib\\guava-11.0.2.jar;lib\\javatuples-1.2.jar;lib\\kryo-2.24.0.jar;lib\\minlog-1.2.jar;lib\\objenesis-1.2.jar;lib\\jarh5obj.jar;lib\\jarhdf-2.10.0.jar;lib\\jarhdf5-2.10.0.jar;lib\\jarhdfobj.jar;lib\\slf4j-api-1.7.5.jar;lib\\slf4j-nop-1.7.5.jar;lib\\mysql-connector-java-5.1.42-bin.jar;lib\\sqljdbc4-2.0.jar;lib\\java-object-diff-0.95.jar\" wrimsv2.components.ControllerBatch "+"-config="+configFilePath);
			}
		}else{
			if (wreslPlus.equalsIgnoreCase("no")){
				out.println("jre\\bin\\java -Xmx"+DebugCorePlugin.xmx+"m -Xss1024K -XX:+CreateMinidumpOnCrash -Duser.timezone=Etc/GMT+8 -Dname="+requestPort+" -Djava.library.path=\"" + externalPath +";" + cbcFolder +";"+gurobiFolder+";"+xaFolder+ ";lib\" -cp \""+externalPath+";"+"lib\\external;lib\\WRIMSv2.jar; lib\\libtensorflow-1.14.0.jar;lib\\calsurrogate.jar;lib\\jep-3.8.2.jar;lib\\jna-3.5.1.jar;lib\\commons-io-2.1.jar;lib\\"+jarXA+";lib\\lpsolve55j.jar;"+solverJarFilePaths+"lib\\heclib.jar;lib\\jnios.jar;lib\\jpy.jar;lib\\misc.jar;lib\\pd.jar;lib\\vista.jar;lib\\guava-11.0.2.jar;lib\\javatuples-1.2.jar;lib\\kryo-2.24.0.jar;lib\\minlog-1.2.jar;lib\\objenesis-1.2.jar;lib\\jarh5obj.jar;lib\\jarhdf-2.10.0.jar;lib\\jarhdf5-2.10.0.jar;lib\\jarhdfobj.jar;lib\\slf4j-api-1.7.5.jar;lib\\slf4j-nop-1.7.5.jar;lib\\mysql-connector-java-5.1.42-bin.jar;lib\\sqljdbc4-2.0.jar;lib\\java-object-diff-0.95.jar\" wrimsv2.components.ControllerBatch "+"-mainwresl="+mainFileAbsPath);
			}else{
				out.println("jre\\bin\\java -Xmx"+DebugCorePlugin.xmx+"m -Xss1024K -XX:+CreateMinidumpOnCrash -Duser.timezone=Etc/GMT+8 -Dname="+requestPort+" -Djava.library.path=\"" + externalPath +";" + cbcFolder +";"+gurobiFolder+";"+xaFolder+ ";lib\" -cp \""+externalPath+";"+"lib\\external;lib\\WRIMSv2.jar;lib\\libtensorflow-1.14.0.jar;lib\\calsurrogate.jar;lib\\jep-3.8.2.jar;lib\\jna-3.5.1.jar;lib\\commons-io-2.1.jar;lib\\"+jarXA+";lib\\lpsolve55j.jar;"+solverJarFilePaths+"lib\\heclib.jar;lib\\jnios.jar;lib\\jpy.jar;lib\\misc.jar;lib\\pd.jar;lib\\vista.jar;lib\\guava-11.0.2.jar;lib\\javatuples-1.2.jar;lib\\kryo-2.24.0.jar;lib\\minlog-1.2.jar;lib\\objenesis-1.2.jar;lib\\jarh5obj.jar;lib\\jarhdf-2.10.0.jar;lib\\jarhdf5-2.10.0.jar;lib\\jarhdfobj.jar;lib\\slf4j-api-1.7.5.jar;lib\\slf4j-nop-1.7.5.jar;lib\\mysql-connector-java-5.1.42-bin.jar;lib\\sqljdbc4-2.0.jar;lib\\java-object-diff-0.95.jar\" wrimsv2.components.ControllerBatch "+"-mainwreslplus="+mainFileAbsPath);	
			}
		}
		out.close();
		showSolverStatus();
	...
	public String generateConfigFile(ILaunchConfiguration configuration, String mainFileAbsPath){
		...
		try {				
			...
			if (DebugCorePlugin.gurobiDlls.containsKey(DebugCorePlugin.gurobiSelVer)){
				out.println("gurobi_dlls               "+DebugCorePlugin.gurobiDlls.get(DebugCorePlugin.gurobiSelVer));
			}
			if (DebugCorePlugin.xaDlls.containsKey(DebugCorePlugin.xaSelVer)){
				out.println("xa_dlls                   "+DebugCorePlugin.xaDlls.get(DebugCorePlugin.xaSelVer));
			}
