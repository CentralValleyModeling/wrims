...
public class JJDocMacMain {
  ...
  static void help_message() {
    ...
    ostr.println("    JJDoc is a preprocessor for JavaCC built by Rob Duncan, Sriram Sankar");
    ostr.println("    and Sreeni Viswanadha, all of Metamata, Inc. (http://www.metamata.com).");
    ostr.println("    To learn more about JavaCC, please visit the JavaCC web site at:");
    ostr.println("                http://www.metamata.com/JavaCC/");
    ...
    ostr.println("    comp.compilers.tools.javacc is a newsgroup devoted to JavaCC and JJTree.");
  }
  ...
  public static void main(String args[]) throws Exception {
    ...
    JavaCCGlobals.bannerLine("Documentation Generator", "");
