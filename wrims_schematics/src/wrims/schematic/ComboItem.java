package wrims.schematic;
	...
	/**
	 * Class allows enabling/disabling of items in a list (e.g., a JComboBox model list).
	 *
	...
	public class ComboItem { // needs to be public for ResultSetTableModel
		 ...
		 * @param the Object to be wrapped
		 */
		...
		/**
		 * CDB added for correct JComboBox setSeletedItem & setSelectedIndex functionality
		 * @return
		 */
		public boolean equals(ComboItem item) {
			if (this == item) return true;
			if (!(item instanceof ComboItem)) return false;
