...
public interface WreslEditorPackage extends EPackage
{
   ...
   * @ordered
   */
  int WRESL_EVALUATOR__INITIAL = 1;
   ...
   * @ordered
   */
  int WRESL_EVALUATOR__SEQUENCE = 2;
   ...
   * @ordered
   */
  int WRESL_EVALUATOR_FEATURE_COUNT = 4;
