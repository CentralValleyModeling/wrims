...
//		setSchematic(schematic);  //CB added
    ...
    public DssAppAction getActions() { return mainPanel.getActions(); }
    public FilterPanel getFP() { return mainPanel.getFilterPanel(); }
    public MessagePanel getMP() { return mainPanel.getMessagePanel(); }
