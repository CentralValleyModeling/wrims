...
public class WreslEditorInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	public Injector getInjector() {
		if (injector == null) {
			this.injector = new WreslEditorStandaloneSetup().createInjectorAndDoEMFRegistration();
		}
		return injector;
	}
