...
: schematic jars  :
:-----------------:
set SCHJARS=%JARDIR%\JDiagram.jar;%JARDIR%\wrims_schematic.jar
:------------:
: class path :
:------------:
...
rem ###############
:start
"%wrims_schematic_home%/jre6/bin/java" -mx512m -Xss1024K -Djava.library.path="%JNILIB%" %CLASSPATH%  wrims.schematic.Schematic "%wrims_schematic_home%"
:end
endlocal 
rem 
