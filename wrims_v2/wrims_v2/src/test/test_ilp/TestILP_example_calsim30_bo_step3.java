...
public class TestILP_example_calsim30_bo_step3 {
	...
	public void calsim3_step3() throws RecognitionException, IOException{
		...
		FilePaths.ilpFileDirectory = studyPath + "ilp_TestIlp_example_calsim30_bo_step3";
		//FilePaths.ilpFile = "test.ilp";
		
        new Controller(controlDataString);

        
        expected = 1.6437561325899855E10; 
