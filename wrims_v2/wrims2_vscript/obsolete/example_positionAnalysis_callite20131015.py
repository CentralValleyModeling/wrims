...
## Step 7. After runs completed, open this dss file to see results: /studies/callite_XXXX/Run/DSS/CalLitePA_demo_DV.dss
#=====================================================================================
...
studyRunDir = path.join(Param.mainScriptDir, "studies/callite_20131015/Run")

# svarOriginalFile is the svar dss file path
svarOriginalFile =path.join(studyRunDir, "../DSS/CL_D1485_20131015_SV.dss")
...
lookupOriginalDir = path.join(studyRunDir, "Lookup", "PA_Base_D1485_Future" )
...
# buffer for svar data
# This is for the lookahead in the variable ann_CSJID in file Stanislaus_dems.wresl
# for example, if bufferYRs=1, sequentialYRs=2, historyWYs=1935, and futureWY=2013, 
# then 1935 svar will be copied to 2013, 
# 1936 svar will be copied to 2014, and
# 1937 svar will be copied to 2015 
bufferYRs = 1  
...
# prepare svar file
    ...
    DssVista.copyDssToFuture_waterYear(svarOriginalFile, svarShiftedFile, beginWY, sequentialYRs, bufferYRs, futureWY, outSvarFpart)    
