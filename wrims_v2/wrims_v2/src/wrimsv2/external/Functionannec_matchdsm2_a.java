...
public class Functionannec_matchdsm2_a extends ExternalFunction{
	...
	public Functionannec_matchdsm2_a(){
	...
	public void execute(Stack stack) {
		...
		if (stack.size()==15){
			...
			float result = annec_matchdsm2_a(Qsac_prv, Qexp_prv, Qsjr_prv, DXC_prv, DICU_prv, Qsac_oth_prv, Qexp_oth_prv, VernEC_prv, mon, location, ave_type, currMonth, currYear, BeginDay, EndDay);
	...
	public native float annec_matchdsm2_a(float[] Qsac_prv, float[] Qexp_prv, float[] Qsjr_prv, float[] DXC_prv, float[] DICU_prv, float[] Qsac_oth_prv, float[] Qexp_oth_prv, float[] VernEC_prv, float[] mon, int location, int ave_type, int currMonth, int currYear, int BeginDay, int EndDay);
}
