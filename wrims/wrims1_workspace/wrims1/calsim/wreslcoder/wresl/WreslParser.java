  ...
  final public void ModelUnit() throws ParseException {
    ...
    default:
      ...
      throw new ParseException();
        ...
        if (s==null) {if (true) throw wreslError(model,"Model '"+model.image+"' not included in sequence!");}
        ...
        try {
            ...
            {if (true) throw new RuntimeException("Unable to initialize output: "+e.getMessage());}
        }
  ...
  final public void ExternalProc(Token id) throws ParseException {
    ...
    default:
      ...
      if (externalList.containsKey(name))
        {if (true) throw wreslError(id, "Redefining External Procedure '" + name + "'");}
      else {
...
//CB	_controlDefines.println("-1               ExternalProc");
      ...
      if (!type.image.toLowerCase().endsWith(".dll")) {
        if (!new File(rootDirectory + "\\" + "external" + "\\",name+".obj").exists())
                {if (true) throw wreslError(id, "External Procedure '" + name + ".obj' does not exist in external directory.");}
        ...
        if (type.image.equalsIgnoreCase("dll")) {
                ...
                {if (true) throw wreslError(id, "External Procedure '" + name + ".lib' does not exist in external directory.");}
...
//CB        _controlDefines.println(make32(name).append(valueDefList.getIdCode(name)));
    ...
    default:
      ...
      noMoreCases(_controlDefines);
        if (caseNum > 1 && !condIsAlways) {if (true) throw wreslError(id,"Final condition must be 'always' for '"+name+"'");}
  }
  ...
  int useMethod = 0;
    ...
    default:
      ...
      if (useMethod==0 && whereColumns.length()==0) {
          {if (true) throw wreslError(table,"Must specify GIVEN and/or WHERE tags");}
      } else if (useMethod==0) {
...
/**
  ...
  */
  ...
  String name = id.image.toUpperCase();
    ...
    if (scope.kind==LOCAL) {
      if ( !tsDefLocalList.newItem(name)) {if (true) throw wreslError(id, "Redefining '" + name + "' within Model");}
  ...
  */
  ...
  String aliasTag = new String(name+"_alias");
    ...
    if (scope.kind==LOCAL) {
      ...
      if (!dvarList.newItem(name))
        {if (true) throw wreslError(id,"Redefining '" + name + "'");}
    ...
    default:
      ...
      throw new ParseException();
        ...
        if (!tagList.newItem(tag.image) || goalLocalList.containsKey(tag.image) ) {
                {if (true) throw wreslError(tag, "Redefining '" + tag.image.substring(1) + "'");}
        }
    ...
    case 99:
      ...
      jj_consume_token(100);
         ...
         try {
             ...
             {if (true) throw wreslError(gp,"Must be an integer");}
         }
         if (level < 1 || level > 9)
             {if (true) throw wreslError(gp,"Priority Level must be between 1 and 9");}
         {if (true) return new Integer(level);}
      break;
    default:
      jj_la1[51] = jj_gen;
      ;
    }
      {if (true) return new Integer(0);}
  ...
  String expr;
    ...
    default:
      ...
      throw new ParseException();
        ...
        if (!caseList.newItem(id.image)) {if (true) throw wreslError(id,
...
/**
  ...
  */
  final public void DayMonthRangeExpression(StringBuffer e) throws ParseException {
        ...
        int length = 5;
    jj_consume_token(DAYMONTH);
                    beg = new String(checkDate(token.image, length));
    jj_consume_token(102);
    jj_consume_token(DAYMONTH);
                    end = new String(checkDate(token.image, length));
...
/**
  ...
  */
  final public void MonthYearRangeExpression(StringBuffer e) throws ParseException {
        String beg, end;
    jj_consume_token(MONTHYEAR);
                     beg = new String(token.image);
    jj_consume_token(102);
    jj_consume_token(MONTHYEAR);
                     end = new String(token.image);
  ...
  */
  ...
  StringBuffer sb = new StringBuffer();
    ...
    default:
      ...
      if (dvarList.getIndexOf(d.image)<0) {if (true) throw wreslError(d,"Decision variable '"      + d.image
  ...
  final public void NonDvarExpression(StringBuffer e) throws ParseException {
    ...
    LinearExpression(expr);
           if (expr.isConstant()) {
               ...
               {if (true) throw wreslError(token, "No decision variable terms allowed here");}
           }
  }
    ...
    while (true) {
      ...
      UnaryExpr(a = new LPTerm());
        ...
        ourTerm.divide(a);
          ...
          {if (true) throw wreslError(x, pe.getMessage());}
      }
    }
  }
      ...
      case IDENTIFIER:
        ...
        // prevent globals from accessing locals
                ...
                tsDefList.getIndexOf(token.image) < 0 &&                //nor global timeseries svar
                        ...
                        {if (true) throw wreslError(token, "Variable '" + token.image + "' not defined within global scope.");}
       ...
       if (reservedList.isIn(token.image)) {
           ...
           {if (true) throw wreslError(token,"Undeclared variable " + token.image);}
       }
        break;
      case CONSTANT:
        jj_consume_token(CONSTANT);
  ...
  Timeseries ts;
    ...
    jj_consume_token(103);
       ...
       if ((pos=dvarList.getIndexOf(x.image))>=0) {
           ...
           {if (true) throw wreslError(x,"Previous values of '"
        + x.image + "' are not available.");}
          ...
          {if (true) throw wreslError(x,"Undeclared Variable '" + x.image + "'");}
       }
  }
  ...
  */
  ...
  Timeseries ts;
    ...
    jj_consume_token(100);
        ...
        {if (true) throw wreslError(x,"Variable '" + x.image + "[]' not accessible from global scope");}
                } else if ((pos=dvarList.getIndexOf(x.image))>=0) {
        ourTerm.coef = new String("dsscycle("+ String.valueOf(pos+1) + ",int(" + e + "))");
                } else if (valueDefList.getIndexOf(x.image) >= 0) {
        {if (true) throw wreslError(x,"Previous values of '" + x.image + "' are not available.");}
        } else if (tsDefList.getIndexOf(x.image) >= 0) {
        {if (true) throw wreslError(x,"Timeseries variable '"      + x.image + "' should not be followed by [] brackets");}
                } else {
        {if (true) throw wreslError(x,"Undefined term in brackets: "+ x.image);}
        }
  }
  ...
  Token x;
    ...
    default:
      ...
      throw new ParseException();
          ...
          if (reforder==null) {
                {if (true) throw wreslError(x,"Model '"+x.image+"' not defined!");}
          } else {
            refint = new Integer(reforder);
      int iref = refint.intValue();
      int icur = _currentOrder.intValue();
      if (iref>=icur) {
        {if (true) throw wreslError(x,"Model '"+refmod+"' may not be referenced here! Not yet solved.");}
      } else {
        e.append(iref-icur);
                        }
          }
...
/**
  ...
  */
  ...
  final private boolean jj_3R_39() {
    if (jj_scan_token(NINT)) return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
