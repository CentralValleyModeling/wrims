...
public class BatchRunProcess {
	...
	private String gurobiSelVer;
	private String xaSelVer;
	...
	public void createBatch(LaunchConfigInfo configuration, String launchFilePath, boolean isWsiDiRun){
		...
		cbcSelVer=configuration.getStringAttribute(DebugCorePlugin.ATTR_WPP_SELCBC, DebugCorePlugin.cbcVers.get(0));
		gurobiSelVer=configuration.getStringAttribute(DebugCorePlugin.ATTR_WPP_SELGUROBI, DebugCorePlugin.gurobiVers.get(0));
		xaSelVer=configuration.getStringAttribute(DebugCorePlugin.ATTR_WPP_SELXA, DebugCorePlugin.xaVers.get(0));
	...
	public void generateBatch(PrintWriter out, String configFilePath){
		...
		*/
		...
		String gurobiFolder="lib\\solvers\\gurobi_"+gurobiSelVer;
		String xaFolder="lib\\solvers\\xa_"+xaSelVer;
		String solverJarFilePaths=FileProcess.createSolverJarFilePaths(cbcFolder, gurobiFolder, xaFolder, cbcSelVer, gurobiSelVer, xaSelVer);
	...
	public String generateConfigFile(LaunchConfigInfo configuration, String mainFileAbsPath, String launchFilePath, boolean isWsiDiRun){
		...
		try {				
			...
			if (DebugCorePlugin.gurobiDlls.containsKey(gurobiSelVer)){
				out.println("gurobi_dlls               "+DebugCorePlugin.gurobiDlls.get(gurobiSelVer));
			}
			if (DebugCorePlugin.xaDlls.containsKey(xaSelVer)){
				out.println("xa_dlls               "+DebugCorePlugin.xaDlls.get(xaSelVer));
			}
