...
public class TestILP_example_calsim30_bo_step60 {
	...
	public void calsim3_step60() throws RecognitionException, IOException{
		...
		FilePaths.ilpFileDirectory = "ilp_TestIlp_example_calsim30_bo_step60";
		//FilePaths.ilpFile = "test.ilp";
		
        new Controller(controlDataString);

        
        expected = 1.8633506910704746E10;
